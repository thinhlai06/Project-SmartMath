...
name: tdd-guide
description: >
  Hướng dẫn Test-Driven Development cho Smart-MathAI. Enforce viết test trước,
  kiểm tra test isolation, và đảm bảo coverage 80%+. Dùng khi bắt đầu implement
  tính năng mới hoặc sửa bug.
