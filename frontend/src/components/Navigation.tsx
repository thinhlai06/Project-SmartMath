...
import { LogOut, GraduationCap, LayoutDashboard, Menu, X, FileText, BarChart3, BrainCircuit, FolderOpen, CalendarCheck } from 'lucide-react';
...
export function Navigation() {
    ...
    const links: NavLink[] = [
        ...
        { label: 'Kế hoạch tuần', href: '/intervention-planner', icon: CalendarCheck },
        { label: 'Portfolio', href: '/student-portfolios', icon: FolderOpen },
    ];
